...
class Equipment(BaseModel):
    equip_head_id: Optional[int] = Field(0, ge=0)
    equip_amulet_id: Optional[int] = Field(0, ge=0)
    equip_torso_id: Optional[int] = Field(0, ge=0)
    equip_legs_id: Optional[int] = Field(0, ge=0)
    equip_boots_id: Optional[int] = Field(0, ge=0)
    equip_cape_id: Optional[int] = Field(0, ge=0)
    equip_hands_id: Optional[int] = Field(0, ge=0)
    equip_weapon_id: Optional[int] = Field(0, ge=0)
    equip_shield_id: Optional[int] = Field(0, ge=0)
